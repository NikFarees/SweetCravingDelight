...
<body>
    ...
    if (isset($_POST['submitChangePassword'])) {
        ...
        if (empty($errors)) {
            ...
            $query = "SELECT agent_id FROM agents WHERE (agent_id='$agent_id' AND
agentPassword=SHA('$password') )";
            ...
            if (mysqli_num_rows($result) == 1) { // Match was made.
                ...
                $query = "UPDATE agents SET agentPassword=SHA('$newPassword') WHERE
agent_id=$row[0]";
                $result = @mysqli_query($dbc, $query); // Run the query.
 ...
 <p>Your password has been updated. </p><p><br /></p>';
                    ...
                    echo '<br/><p> <a href="profileAgent.php" style="color: blue; text-decoration:
underline;">Ok</a> </p>';
...
apologize for any inconvenience.</p>'; // Public message.
 ...
 <p class="error">The following error(s) occurred:<br />';
    ...
    ?>
    <br />
    <p> <a href="profileAgent.php" style="color: blue; text-decoration:
underline;">Back</a></p><br />
    <h2>Change Your Password</h2>
    <form action="changePassword.php" method="post">
        <p>Current Password: <input type="password" name="password" size="20"
                maxlength="40" /></p>
        <p>New Password: <input type="password" name="password1" size="20" maxlength="40" /></p>
        <p>Confirm New Password: <input type="password" name="password2" size="20"
                maxlength="40" /></p>
